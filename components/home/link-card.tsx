  ...
  return (
    <motion.li variants={FRAMER_MOTION_LIST_ITEM_VARIANTS}>
      ...
      <motion.div
        ...
        whileTap={{ scale: 1.05 }}
        className="flex max-w-lg cursor-grab items-center justify-between rounded-md border border-gray-200 bg-white p-3 shadow-lg transition-[border-color] hover:border-black active:cursor-grabbing"
      >
