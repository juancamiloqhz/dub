...
// This is a special route for retrieving and creating custom corewave.xyz links.
export default withUserAuth(
  async (req: NextApiRequest, res: NextApiResponse, session: Session) => {
    // GET /api/links – get all corewave.xyz links created by the user
    if (req.method === "GET") {
      ...
      if (hostname === "corewave.xyz" && pathname === `/${key}`) {
